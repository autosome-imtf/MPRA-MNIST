...
# from https://github.com/pinellolab/chorus/
import os
import gzip
...
from .info import  DEFAULT_ROOT

MPRAMNIST_GENOMES_DIR = os.path.join(DEFAULT_ROOT, 'genomes')
...
class GenomeManager:
    ...
    def __init__(self, genomes_dir: Optional[Path] = None):
        ...
        if genomes_dir is None:
            ...
            genomes_dir = MPRAMNIST_GENOMES_DIR
